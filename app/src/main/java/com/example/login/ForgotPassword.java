    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recuperarBoton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.isEmpty()) {
                    final Toast enterEmailToast = Toast.makeText(ForgotPassword.this, "\uD83D\uDEA8 Ingresa tu Correo \uD83D\uDEA8", Toast.LENGTH_SHORT);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            final Toast emailSentToast = Toast.makeText(ForgotPassword.this, "\uD83D\uDCE8 Correo Enviado ✅", Toast.LENGTH_SHORT);
                            emailSentToast.show();
                            ...
                            final Toast incorrectEmailToast = Toast.makeText(ForgotPassword.this, "\uD83D\uDEA8 Correo Incorrecto \uD83D\uDEA8", Toast.LENGTH_SHORT);
