...
public class Entrada extends AppCompatActivity {
    ...
    // Inicia/detiene la escucha de cambios en el adaptador cuando la actividad comienza/se detiene.
    // Configura la actividad al iniciarse, incluyendo la inicialización de Firebase Firestore,
    // la configuración del RecyclerView con datos de usuarios y la asignación del adaptador al RecyclerView.
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CreateUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Entrada.this, CrearUsuario.class);
        ...
        btn_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mAuth.signOut();
                finish();
                startActivity(new Intent(Entrada.this, login.class));
            }
        });
