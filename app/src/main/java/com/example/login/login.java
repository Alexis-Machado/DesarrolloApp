...
public class login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Redirección a la actividad de registro al hacer clic en "Registrarme".
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(emailUser.isEmpty() && passUser.isEmpty()) {
                    final Toast toast = Toast.makeText(login.this, "\uD83D\uDEA8 Ingresa tus Datos \uD83D\uDEA8", Toast.LENGTH_SHORT);
                    toast.show();
        ...
        mAuth.signInWithEmailAndPassword(emailUser, passUser).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    final Toast welcomeToast = Toast.makeText(login.this, "\uD83C\uDF89 \uD83C\uDF0D¡BIENVENIDO!\uD83C\uDF0E \uD83C\uDF89", Toast.LENGTH_SHORT);
                    welcomeToast.show();
                    ...
                    final Toast incorrectToast = Toast.makeText(login.this, "Correo o Contraseña Incorrectos \uD83D\uDE27", Toast.LENGTH_SHORT);
                    incorrectToast.show();
            ...
            public void onFailure(@NonNull Exception e) {
                final Toast errorToast = Toast.makeText(login.this, "Error al Iniciar Sesión \uD83D\uDD12", Toast.LENGTH_SHORT);
                errorToast.show();
